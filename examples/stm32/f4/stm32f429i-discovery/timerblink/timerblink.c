...
int main(void)
{
    ...
    while (1) {
        ...
        // 0% angular → 5% duty
        timer_set_oc_value(TIM1, TIM_OC1, 328);
        delay_s(2);

        // 10% angular → 5.5% duty
        timer_set_oc_value(TIM1, TIM_OC1, 361);
        delay_s(1);
        ...
        // 50% angular → 7.5% duty
        timer_set_oc_value(TIM1, TIM_OC1, 492);
        delay_s(1);
